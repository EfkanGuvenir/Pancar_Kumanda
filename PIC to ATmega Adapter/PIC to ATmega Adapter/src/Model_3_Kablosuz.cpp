...
//*---- Model_3 Kablosuz Kumandaya Uygundur----*//
...
//* Pin Out
const int ortak_valf = 2;
const int ok_sol_valf = 4;
const int ok_sag_valf = 29;
const int bosalt_valf = 31;
const int bosalt_dur_valf = 22;
const int sepet_yukari_valf = 20;
const int sepet_asagi_valf = 18;
const int sokum_yukari_valf = 28;
const int sokum_asagi_valf = 12;
const int hazirlayici_asagi_valf = 3;
const int hazirlayici_yukari_valf = 30;
const int sokum_valf = 23;
const int geri_valf = 21;
const int ortak_2_valf = 19;
const int yedek_1_valf = 11;
const int yedek_2_valf = 15;
/**************************************************************/

...
bool bit0 = 0, bit1 = 0, bit2 = 0, bit3 = 0, bit4 = 0, bit5 = 0, bit7 = 0, bit8 = 0, bit9 = 0, bit10 = 0, bit11 = 0, bit12 = 0, bit13 = 0, bit14 = 0, bit15 = 0;
bool bit6 = 1; // Depo  ON-Off
    ...
    while (1)
    {
        ...
        if (val != -1)
        {
            ...
            case 7: // Makina Ters
                bit15 = 1;
                break;
            case 13: // Hazırlayıcı Yukarı
                bit9 = 1;
                break;
            case 14: // Hazırlayıcı  Aşağı
                bit10 = 1;
                break;
            case 5: // Kırma  Kapalı
                bit7 = 1;
        ...
        {
            otomatik_btn_flag = 0;   // Otomatik buton bırakıldıysa flag sıfırlanır
            ...
            if (depo_aktif)
            {
                bit6 = 0; // Depo aktifse bit6'yı 0 yap
                bit5 = 1; // Depo aktifse bit5'i 1 yap
            }
            else
            {
                bit5 = 0; // Depo pasifse bit5'i 0 yap
                bit6 = 1; // Depo pasifse bit6'yı 1 yap
            }

            bit1 = 0, bit2 = 0, bit3 = 0, bit4 = 0, bit7 = 0, bit8 = 0, bit9 = 0, bit10 = 0, bit11 = 0, bit12 = 0, bit14 = 0, bit15 = 0;
        }

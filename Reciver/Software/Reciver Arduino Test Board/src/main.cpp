...
int otomatik_led = 3;          // Otomatik Söküm Sisteme Girdiğinde bildirim ışığı
int sokum_led = 4;             // Söküm Sisteme Girdiğinde bildirim ışığı
int RX_data_otomatik_led = 13; // RF'den Gelen Veri Olduğunda Bildirilecek led
